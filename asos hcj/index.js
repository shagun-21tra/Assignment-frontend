...
let productBlock = document.querySelector("#asosProductSeperateDivision")
let container = document.querySelector("#container");
let menHomePageBlock1 = document.querySelector("#firsta");
let menHomePageBlock2 = document.querySelector("#bgi");
let menHomePageBlock3 = document.querySelector("#thirdb");
let menHomePageBlock4 = document.querySelector("#imga");
let menHomePageBlock5 = document.querySelector("#pic");
let menHomePageBlock6 = document.querySelector("#td");
...
let productDisplayCheck = JSON.parse(localStorage.getItem("selectedItemJumpToProduct")) || [];
if (productDisplayCheck.length != 0) {
...
function emptyMenandWomenFunction() {
    menHomePageBlock1.style.display = "none";
    menHomePageBlock2.style.display = "none";
    menHomePageBlock3.style.display = "none";
    menHomePageBlock4.style.display = "none";
...
function sort1List5function() {
    ...
    document.querySelector("#selectSort8").value = "Size";
    liveData = JSON.parse(localStorage.getItem("shoeProdDataLS"));
    sortingFunction(liveData); emptyMenandWomenFunction();
}
...
function userInfoDispFunction() {
    ...
    let userLoginDataFromLs=JSON.parse(localStorage.getItem("logInUserData"))||[];
    let div1 = document.createElement("div");
    let div2 = document.createElement("div");
    ...
    p1.innerText = "Hi "+userLoginDataFromLs.firstname;
    p2.innerText = "Sign out";
    p2.addEventListener("click",function(){
        let a={};
        localStorage.setItem("logInUserData",JSON.stringify(a));
...
document.querySelector("#asosUserCartHeading").addEventListener("click",function(){
    window.location.href="primaryCart.html";
})
document.querySelector("#asosUserCartHeading").style.cursor="pointer";

document.querySelector("#firsta>div:nth-child(3)>div:nth-child(1)").addEventListener("click",sort1List1function);
document.querySelector("#firsta>div:nth-child(3)>div:nth-child(2)").addEventListener("click",sort4List2function);
document.querySelector("#firsta>div:nth-child(3)>div:nth-child(3)").addEventListener("click",sort1List12function);
document.querySelector("#firsta>div:nth-child(3)>div:nth-child(4)").addEventListener("click",sort4List3function);
document.querySelector("#firsta>div:nth-child(3)>div:nth-child(5)").addEventListener("click",sort4List8function);
document.querySelector("#firsta>div:nth-child(3)>div:nth-child(6)").addEventListener("click",sort4List19function);
